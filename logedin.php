...
<!DOCTYPE html>
			...
			<div style="margin-top:0px;background-color: gray;">
													...
													<div class="w3-row-padding" style="margin:4px 40px 40px 40px;background-color:white;border:0px sloid;border-radius:7px">
														<h1> 
															...
															<th><a href="#shto" onclick="myFunction()" style ="padding:6px 6px;margin-right:40px;color:black;background-color:#6ee96e;border-radius: 4px;font-size:11px" class="btn w3-right" ><b>+ Shtoni një agjent</b></a></th>
												...
												<div class="center"  id="shto" >
														<a href="#" onclick="myFunction()" style ="padding:6px 6px;align:right;color:black;background-color:#FFD2D2;border-radius: 4px;font-size:11px" class="btn w3-right" ><b>&nbsp;X&nbsp;</b></a>
	...
	<script>
		function myFunction() {
		  var x = document.getElementById("shto");
